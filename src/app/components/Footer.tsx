        ...
        >
          ...
          <div style={{ backgroundColor: '#0a0f28', padding: '0 0 48px 40px', borderLeft: '1px solid rgba(30,64,175,0.15)' }} className="footer-col">
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <li>
                <a href="mailto:info@nultatinternationalgroup.com" style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', textDecoration: 'none' }}>
                  <MdEmail size={14} style={{ color: '#1e40af', marginTop: '2px', flexShrink: 0 }} />
                  <span style={{ fontSize: '13px', color: '#64748b', lineHeight: 1.5 }}>info@nultatinternationalgroup.com</span>
                </a>
              </li>
              <li>
