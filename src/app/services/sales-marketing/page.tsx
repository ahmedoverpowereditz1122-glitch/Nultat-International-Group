...
const services = [
  {
    ...
    description:
      'Identifying growth opportunities, building strategic partnerships, and expanding market presence to drive long-term business success.',
  },
  {
    icon: Target,
    title: 'Lead Generation',
    description:
      'Generating and qualifying prospects through outbound campaigns, inbound marketing, networking, and digital channels to grow your sales pipeline.',
  },
  {
    icon: UserCheck,
    title: 'Client Services',
    description:
      'Managing customer relationships, ensuring client satisfaction, handling escalations, and supporting long-term retention for sustainable growth.',
  },
  {
    icon: LifeBuoy,
    title: 'Sales Support',
    description:
      'Providing administrative and operational support to sales teams, including CRM management, proposal preparation, reporting, and coordination.',
  },
  {
    icon: PhoneCall,
    title: 'Inside & Outside Sales',
    description:
      'Conducting remote sales activities via phone, email, and video, as well as field-based sales engagements to acquire and manage customers.',
  },
  {
    icon: ShoppingBag,
    title: 'B2B & B2C Online Selling',
    description:
      'Selling products and services to businesses and consumers through e-commerce platforms, marketplaces, and digital sales funnels.',
  },
  {
    icon: Globe,
    title: 'Digital / Internet Marketing',
    description:
      'Using SEO, SEM, social media, email marketing, content marketing, and analytics to drive brand awareness and increase conversions.',
  },
  {
    icon: Share2,
    title: 'Affiliate Marketing',
    description:
      'Building partnerships with affiliates and influencers to promote products or services on a performance-based model for maximum ROI.',
  },
  {
    icon: Network,
    title: 'Multi-Level & Global Marketing',
    description:
      'Supporting scalable network-based sales models and international market expansion strategies across diverse regions and customer segments.',
  },
]

const whyUs = [
  'Proven sales strategy and pipeline management',
  'Expert negotiation and closing techniques',
  'CRM and advanced sales analytics',
        ...
        <section style={{
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 32px', position: 'relative', zIndex: 1 }}>
            ...
            >
              ...
              <span style={{ color: '#334155', fontSize: '12px' }}>/</span>
              <span style={{ fontSize: '12px', color: '#93c5fd', fontWeight: 600 }}>Sales & Marketing</span>
            </motion.div>
            ...
            >
              Sales & <span style={{ color: '#60a5fa' }}>Marketing</span>
            </motion.h1>
            ...
            >
              Drive revenue, expand your market presence, and build lasting customer relationships
              through expert sales strategies and high-impact marketing solutions.
            </motion.p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }} className="why-grid">
              ...
              >
                ...
                <p style={{ fontSize: '15px', color: '#64748b', lineHeight: 1.8, marginBottom: '36px' }}>
                  Our goal is to help businesses increase revenue, improve conversion rates,
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '32px' }} className="cta-row">
              <div>
                ...
                <h2 style={{
                  ...
                  Let's grow your sales and reach new markets together.
                </h2>
              </div>
